...
/**
 * Tabla de precios de la landing pública. Presentacional únicamente: no
 * consulta Supabase ni Stripe. Los botones son placeholders (`href="#"`)
 * hasta que se configuren los enlaces de checkout de Hotmart.
 */
        ...
        <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
          {PLANS.map((plan) => (
            ...
            >
              ...
              {/*
                TODO(Hotmart): reemplazar este href="#" por el enlace de
                checkout de Hotmart correspondiente a este plan.
              */}
              <a
                href="#"
                className={
